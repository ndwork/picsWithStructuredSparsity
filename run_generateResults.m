...
function run_generateResults( varargin )
  close all; rng(1);
  addpath( './dworkLib' );
  ...
  if numel( trueRecon ) == 0
    ...
    showAndSaveThisImg( mainOut, abs(roemerRecon), 'roemerReconTrue', 'showScale', showScale );
  ...
  fprintf( logID, 'sampleFraction, nSamples, Algorithm, mse, mae, relErr, ' );
  ...
  parfor nSamplesIndx = 1 : nNSampleFracs
    ...
    outDir = [ mainOut, filesep, 'nSamples_', indx2str( nSamples, maxNSamples ) ];
    ...
    printMetrics( logFile,  sampleFraction, nSamples, reconRoemer, ...
    ...
    printMetrics( logFile,  sampleFraction, nSamples, reconRoemerWav, ...
    ...
    printMetrics( logFile,  sampleFraction, nSamples, reconRoemerCurv, ...
    ...
    printMetrics( logFile,  sampleFraction, nSamples, reconRoemerWavCurv, ...
  ...
  parfor outIndx = 1 : nNSampleFracs * nLambdas
    ...
    outDir = [ mainOut, filesep, filesep, 'nSamples_', indx2str( nSamples, maxNSamples ) ];
    if ~exist( outDir, 'dir' ), mkdir( outDir ); end
    ...
    printMetrics( logFile,  sampleFraction, nSamples, reconSSP_wav, ...
    ...
    printMetrics( logFile,  sampleFraction, nSamples, reconSSP_curv, ...
    ...
    printMetrics( logFile,  sampleFraction, nSamples, reconSSP_wavCurv, ...
  ...
  parfor outIndx = 1 : nNSampleFracs * nLambdas
    ...
    printMetrics( logFile,  sampleFraction, nSamples, reconSparseSense, ...
    ...
    printMetrics( logFile,  sampleFraction, nSamples, reconSparseSense_wav, ...
    ...
    printMetrics( logFile,  sampleFraction, nSamples, reconSparseSense_curv, ...
    ...
    printMetrics( logFile,  sampleFraction, nSamples, reconSparseSense_wavCurv, ...
